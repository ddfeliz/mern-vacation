        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <PresentationChartLineIcon type='icon' className='fill-current w-5 h-6'/>
                        Tableau de bord
                        <svg
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="présidence-service-finance/tableau-de-bord"
                              className={({ isActive }) =>
              ...
              {/* <!-- Menu Item Correcteurs --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === 'correcteur' || pathname.includes('correcteur')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <UserGroupIcon  className='fill-current w-5 h-6'/>
                        Correcteurs
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                            }`}
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === 'tarif' || pathname.includes('tarif')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ShoppingCartIcon  className='fill-current w-5 h-6'/>
                        Tarifs
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                            }`}
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <DocumentArrowUpIcon className='fill-current w-5 h-6'/>
                        Vacation
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                            }`}
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <DocumentCurrencyEuroIcon className='fill-current w-5 h-6'/>
                        Paiement du vacation
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                            }`}
                          width="20"
