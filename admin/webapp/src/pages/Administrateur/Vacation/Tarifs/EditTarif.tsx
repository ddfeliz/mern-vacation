...
const EditTarif = () => {
  ...
  useEffect(() => {
    ...
    const fetchTarif = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`https://gestion-vacation.onrender.com/api/tarif/${idTarif}`);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.put(`https://gestion-vacation.onrender.com/api/tarif/${idTarif}`, {
        optionTarif,
        nombreTarif,
        MontantTarif
      });
              ...
              <div className="flex items-center justify-center min-h-screen">
                <DialogPanel className="relative mx-auto w-full max-w-md rounded-lg bg-white shadow-lg p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <DialogTitle className="text-xl font-medium text-gray-900">Mise à jour réussie</DialogTitle>
              ...
              <div className="p-6.5">
                <div className="mb-4.5 flex flex-col xl:flex-row gap-6">
                  <div className="w-full xl:w-1/2">
                    <label htmlFor="optionTarif" className="mb-2.5 block text-black dark:text-white">
                    ...
                    >
                      ...
                      <option value="Par nombre du copie">Par nombre du copie</option>
                      <option value="Par forfaitaire">Par forfaitaire</option>
                    </select>
                  </div>

                  <div className="w-full xl:w-1/2">
                    <label htmlFor="nombreTarif" className="mb-2.5 block text-black dark:text-white">
                ...
                <div className="mb-4.5 flex flex-col xl:flex-row gap-6">
                  <div className="w-full xl:w-1/2">
                    <label htmlFor="MontantTarif" className="mb-2.5 block text-black dark:text-white">
