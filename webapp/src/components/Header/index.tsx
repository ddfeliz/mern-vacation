...
import LogoIcon from '../../images/logo/UnivTol-Logo.png';
      ...
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <Link className="block flex-shrink-0 lg:hidden" to="/">
            <img src={LogoIcon} alt="Logo" className='rounded-lg w-10'/>
          </Link>
        </div>
        ...
        <div className="hidden sm:block">
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Automatisez les paiements et réduisez les erreurs."
                disabled
                className="w-full bg-transparent pl-9 pr-4 text-black focus:outline-none dark:text-white xl:w-125 max-md:hidden"
              />
            </div>
          </form>
        </div>
